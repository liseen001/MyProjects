...
class ExcelUtils(object):
    '''
    判断是否是excel文件再进行处理  xls xlsx 并且文件存在
    '''
    ...
    @property
    def get_sheet_data_bt_list(self):
        all_excel_data = []
...
if __name__ == "__main__":
    ...
    sheet_infos = ExcelUtils(test_data_path,'login_suite').get_sheet_data_bt_list
    print(sheet_infos,test_data_path)